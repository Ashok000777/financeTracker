...
if (isset($_SESSION['user_id'])) {
    ...
    // SQL query to sum credit amounts based on common descriptions
    $sql = "SELECT description, SUM(amount) AS total_amount
            FROM transactions
            WHERE transaction_type = 'credit' AND user_id = ?  -- Fetching only credit transactions for the logged-in user
